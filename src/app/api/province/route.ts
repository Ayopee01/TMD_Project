...
import type { NominatimResponse, ProvinceFail, ProvinceResponse } from "@/types/tmd";
import { buildNominatimUrl, normalizeProvinceThai, pickProvinceThai ,  } from "@/lib/province";
